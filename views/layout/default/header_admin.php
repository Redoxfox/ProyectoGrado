        ...
        <div class="menu-list">
            ...
            <ul id="menu-content" class="menu-content collapse out">
                ...
                <ul class="sub-menu collapse" id="products">
                    ...
                    <li><a href="<?php echo BASE_URL.'admin'.DS.'Lista_MPrimas'?>">Lista MPrimas</a></li>
                    <li><a href="<?php echo BASE_URL.'admin'.DS.'Lista_Productos'?>">Lista PTerminados</a></li>
                ...
                <ul class="sub-menu collapse" id="product">
                    ...
                    <li><a href="<?php echo BASE_URL.'admin'.DS.'Gestion'.DS.'Proveedor'?>">Nuevo Proveedor</a></li>
                </ul>
